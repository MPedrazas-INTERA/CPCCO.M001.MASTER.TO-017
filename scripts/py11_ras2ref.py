...
'''
- Extract values from TIF files given grid cell centroids (or any xy locations)
- Input: tif file, grid coordinates
- Outputs: ref dat files, csv, shapefiles
 last run 3/26/2023 for RUM aquifer mapped plume cy2021
...
if __name__ == "__main__":
    ...
    opt = 'unconfined_2021' #  unconfined_2021 or RUM_2021 or unconfined_2020
    ...
    # For RUM unconfined aquifer, 2021
    if opt == 'unconfined_2021':
        raster_file = f'../gis/raster/CrVI_CY2021_unconfined/Hexavalent_Chromium_LO.tif' # mapped plumes unconfined aq for cy2021
        ofile = "output/mapped_plumes/HexCr_2021_unconfined.dat" # mapped plumes unconfined for cy2021
    elif opt == 'RUM_2021':
        # For RUM aquifer, 2021
        raster_file = f'../gis/raster/CrVI_CY2021_RUM/Hexavalent Chromium.tif' # mapped plumes RUM aq cy2021'
        ofile = f'output/mapped_plumes/HexCr_2021_RUM.dat' # mapped plumes RUM for cy2021
    elif opt == 'unconfined_2020':
        # For unconfined aquifer, cy2020
