...
if __name__ == "__main__":
    ...
    for yr in list_yr:
        for i in list_months:
            if yr >= 2022:
                raster_file = f'{wdir}/raster_files/{yr}/PROD_Termby_043022_WL_{i}.asc'
            if yr==2021:
                raster_file = f'{wdir}/raster_files/{yr}/PROD_Termby_043022_WL_{i}.asc'
            elif yr==2020:
                raster_file = f'{wdir}/raster_files/{yr}/PROD_Termby_02102020_WL_{i}.asc'
            elif yr<=2019:
    ...
    # Prepare data for GW Vistas after 2021 only.
    ...
    dfghb_final.to_csv(f'../model_packages/hist_2014_2021/ghb/GHBdata2GWV_all.csv', index=False)
    dfghb_final2 = dfghb_final[dfghb_final['check']=='good']
    dfghb_final2.to_csv(f'../model_packages/hist_2014_2021/ghb/GHBdata2GWV_good.csv', index=False)
