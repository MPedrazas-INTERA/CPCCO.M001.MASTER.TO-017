...
def add_SP2mod2obs_ofile(inputDir):
    ...
    print("Modified first SP for all the .dats printed")
...
if __name__ == "__main__":
    ...
    case = 'flow_2014_2022' ##model run of interest
    cwd = os.getcwd()
    inputDir = os.path.join(os.path.dirname(cwd), f'{case}', 'BC_mod2obs')
    ...
    add_SP2mod2obs_ofile(inputDir)

    ave2 = datbywell(inputDir, wellDict)
